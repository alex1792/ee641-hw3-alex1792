...
class LearnedPositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model, max_len=5000):
        ...
        # Initialize embeddings (e.g., normal distribution)
    ...
    def forward(self, x):
        ...
        # Get position indices using torch.arange(seq_len, device=x.device)
        ...
        # Look up position embeddings using self.position_embeddings
